...
namespace ExampleApp
{
    ...
    {
        [Option('f', "file", Required = false, HelpText = "Name of registry hive to process")]
        public string HiveName { get; set; }

        [Option('d', "directory", Required = false, HelpText = "Name of directory to lok for registry hives to process")]
        public string DirectoryName { get; set; }

        [Option('e', DefaultValue = false, Required = false, HelpText = "If true, export a file that can be compared to other Registry parsers")]
        public bool ExportHiveData { get; set; }

        [Option('p', DefaultValue = false, Required = false, HelpText = "If true, pause after processing a hive and wait for keypress to continue")]
        public bool PauseAfterEachFile { get; set; }

        [Option('a', DefaultValue = false, Required = false, HelpText = "If true, only recovered deleted keys/values will be exported")]
        public bool ExportDeletedOnly { get; set; }

        [Option('r', DefaultValue = false, Required = false, HelpText = "If true, recover and process deleted Registry keys/values")]
        public bool RecoverDeleted { get; set; }

        [Option('v', DefaultValue = 0, Required = false, HelpText = "Verbosity level. 0 = Info, 1 = Debug, 2 = Trace")]
